...
%--------------------------------------------------------------------------
    ...
    methods
        function main(Algorithm,Problem)
            %% Parameter setting
            [pSBX, sbxDI, pm, pmDI, tournament, mode, neighbour] = Algorithm.ParameterSet(1,2,3,4,5,6,7);
            ...
            while Algorithm.NotTerminated(Population)
                ...
                for i = 1 : Problem.N
                    ...
                    Offspring = OperatorGAhalf(Population(P(1:2)),{proC,disC,proM,disM});
