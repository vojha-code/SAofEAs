...
YA = model_evaluation(myfun,XAp,prec,temp,ept,flow,warmup,Case) ; % size (N,1)
YB = model_evaluation(myfun,XBp,prec,temp,ept,flow,warmup,Case) ; % size (N,1)
YC = model_evaluation(myfun,XCp,prec,temp,ept,flow,warmup,Case) ; % size (N*M,1)
